    ...
    <Box sx={{display:'flex'}} minHeight={'90vh'} maxHeight={'90vh'} gap={1}>
      ...
      <Box flex={1} sx={{boxShadow:3, margin:1, marginTop:5, height:'100%',
        ...
        <Button variant="outlined"
          ...
          sx={{marginTop:5, bgcolor:'#008874', color:'#fff', 
